  ...
  <body>
   <div class="container">
    <a href="{{url('/admin_team')}}" class="btn btn-primary my=3">Team</a>
     ...
     <form action="{{url('team/update/' .$team_edit->id)}}"  method="post">
    @csrf
      <div class="form-group">
        <label for="">Team Name</label>
        <input type="string" class="form-control" name="team_name"value="{{$team_edit->team_name}}" placeholder="Enter the team name">
        @error('name')
